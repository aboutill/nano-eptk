...
from nano_eptk.eppipe.dhcp_epi import dhcp_epi_pocr
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        ...
        description=(
            ...
            "\n"
            "Apply the dHCP EPI-POCR pipeline on input data.\n"
            "\n"    
            "Required arguments:\n"
            " - Input magnitude.\n"
            " - Input phase.\n"
...
def execute_dhcp_epi_pocr_with_datalist(
        input_mag_path=None,
        input_pha_path=None,
...
def main():
    ...
    # Main function call
    execute_dhcp_epi_pocr_with_datalist(
