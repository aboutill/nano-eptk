...
from nano_eptk.eprecon.fd_kernels import gradient_kernel, laplacian_kernel
from nano_eptk.tools.mrtrix import mrtrix_multiply
from nano_eptk.utils.mask import erode_mask
from nano_eptk.utils.metrics import extract_ep_metrics
...
def _save_cmpl_nifti(cmpl, header, affine, output_path):
    ...
    nib.save(mag_nii, output_path+"_mag.nii.gz")

    # Save phase
    pha_nii = nib.Nifti1Image(pha, affine, header)
    nib.save(pha_nii, output_path+"_pha.nii.gz")
