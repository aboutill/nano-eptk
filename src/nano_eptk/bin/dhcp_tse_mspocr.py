...
from nano_eptk.eppipe.dhcp_tse import dhcp_tse_mspocr
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        prog="dhcp_tse_mspocr",
        description=(
            "dhcp_tse_mspocr: part of nano eptk package.\n"
            "\n"
            "Apply the dHCP TSE-MSPOCR pipeline on input data.\n"
            "\n"    
            "Required arguments:\n"
...
def execute_dhcp_tse_mspocr_with_datalist(
...
def main():
    ...
    # Main function call
    execute_dhcp_tse_mspocr_with_datalist(
